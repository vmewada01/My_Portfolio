    ...
    <section id="projects" className="mb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white shadow-md rounded-lg p-6">
          <h3 className="text-xl font-semibold mb-2">Flipkart-VMS</h3>
        ...
        <div className="bg-white shadow-md rounded-lg p-6">
          <h3 className="text-xl font-semibold mb-2">APS - Advanced Planning and Scheduling</h3>
          <ul className="list-disc list-inside">
        ...
        <div className="bg-white shadow-md rounded-lg p-6">
          <h3 className="text-xl font-semibold mb-2">Generative AI-based Room Interior Designing App</h3>
          <ul className="list-disc list-inside">
